...
### AI course generation (Enterprise + AI add-on)
...
### AI course refinement (Enterprise + AI add-on)
...
| **Enterprise + AI add-on** | Everything above, plus the four AI course-generation tools. Subject to a separate, stricter quota (5 calls per key per day, 50 per tenant per day) since each call burns Gemini quota. |
